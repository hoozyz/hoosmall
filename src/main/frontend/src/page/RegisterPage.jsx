...
function RegisterPage() {
    ...
    const emailDuplicate = async () => { // 중복체크
    ...
    const passwordCheck = (pwd) => {
        if(passwordRegEx.test(pwd)) { // 비밀번호 형식이 맞을 때
            setPwd(pwd);
            setIsPwd(true);
            setWrongPwd("");
        } else {
